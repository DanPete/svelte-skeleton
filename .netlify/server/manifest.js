...
const manifest = {
  ...
  _: {
    mime: { ".png": "image/png" },
    entry: { "file": "start-097528bf.js", "js": ["start-097528bf.js", "chunks/vendor-57a2be19.js", "chunks/preload-helper-ec9aa979.js"], "css": [] },
    nodes: [
    ...
    routes: [
      ...
      },
      {
        ...
        params: null,
        load: () => Promise.resolve().then(() => __toModule(require("./entries/endpoints/posts/post.json.ts.js")))
      },
      {
        type: "page",
        pattern: /^\/posts\/about\/?$/,
